            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{asset('dark')}}/img/user.jpg" alt=""
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route('lembaga.index')}}" class="dropdown-item">Lembaga</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa-solid fa-building-user fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Data Lembaga</p>
                                <h6 class="mb-0">{{DB::table('lembaga')->count()}} Data</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa-solid fa-id-badge fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Data Pengurus</p>
                                <h6 class="mb-0">{{DB::table('pengurus')->count()}} Data</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Data Jurusan</p>
                                <h6 class="mb-0">{{DB::table('jurusan')->count()}} Data</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Azhari Web Dev</a>, All Right Reserved.
                        </div>
